...
// Buscar traz as publicações dos usuarios seguidos e também do proprio usuario.
...
// BuscarPorUsuario traz todas as publicacoes de um usuario
func (repositorio Publicacoes) BuscarPorUsuario(usuarioID uint64) ([]modelos.Publicacao, error) {
	...
	var publicacoes []modelos.Publicacao //slice de publicacoes

	for linhas.Next() {
		var publicacao modelos.Publicacao // uma publicacao especifica pra preencher o slice
		if erro = linhas.Scan(
			&publicacao.ID,
			&publicacao.Titulo,
			&publicacao.Conteudo,
...
// Curtir aumenta o numero de curtidas em 1
...
// Descurtir diminui o numero de curtidas em 1
